      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-0 pb-8 space-y-6">
        ...
        <Dialog open={showExtensionModal} onOpenChange={setShowExtensionModal}>
          <DialogContent className="max-w-md bg-white">
            ...
            <DialogHeader>
              <DialogTitle className="text-center text-xl font-bold text-gray-800 mb-2">확장프로그램 설치 필요</DialogTitle>
            </DialogHeader>
            <div className="text-center space-y-4 p-4">
              <div className="mx-auto w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center">
                <Download className="w-8 h-8 text-blue-600" />
              </div>
              <p className="text-gray-600">상품 분석을 위해 Chrome 확장프로그램을 설치하고,<br />새로고침 해주세요.</p>
              <Button
                onClick={() => {
